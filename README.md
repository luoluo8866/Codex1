...
This repository packages a Codex skill for expanding brief experimental steps into a complete Chinese experimental protocol.
...
- `experiment-protocol-writer/`: Codex skill folder.
- `experiment-protocol-writer-package.md`: install and usage notes.
- `experiment-protocol-writer.zip`: packaged archive.
